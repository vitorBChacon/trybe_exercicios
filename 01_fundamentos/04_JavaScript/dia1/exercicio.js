...
if (salario <= 1556.94) {
  valorFinal = salario * 0.92;
  console.log(valorFinal);
}else if (salario > 1556.94 && salario < 2594.92) {
  salarioDeduzido = salario * 0.91;
  if (salarioDeduzido <= 1903.98) {
    valorFinal = salarioDeduzido;
    console.log(valorFinal);
  }else if(salarioDeduzido > 1903.98 && salarioDeduzido <= 2826.65) {
    impostoDeRenda = salarioDeduzido * 0.075 -(142.80);
    valorFinal = salarioDeduzido - impostoDeRenda;
    console.log(valorFinal)
  }else if(salarioDeduzido > 2826.65 && salarioDeduzido <= 3751.05) {
    impostoDeRenda = salarioDeduzido * 0.15 -(354.80);
    valorFinal = salarioDeduzido - impostoDeRenda;
    console.log(valorFinal)
  }else if(salarioDeduzido > 3751.05 && salarioDeduzido <= 4664.68) {
    impostoDeRenda = salarioDeduzido * 0.225 -(636.13);
    valorFinal = salarioDeduzido - impostoDeRenda;
    console.log(valorFinal)
  }else {
    impostoDeRenda = salarioDeduzido * 0.275 -(869.36);
    valorFinal = salarioDeduzido - impostoDeRenda;
    console.log(valorFinal)
  }
